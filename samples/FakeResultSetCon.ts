...
// This sample program demonstrates the behavior of the fake_result_sets connection parameter.
...
const con: teradatasql.TeradataConnection = teradatasql.connect({ host: "whomooz", user: "guest", password: "please", fake_result_sets: "true" });
try {
