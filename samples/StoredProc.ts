...
function DisplayResults(cur: TeradataCursor): void {
    while (true) {
...
function cur_execute(cur: TeradataCursor, sSQL: string, params?: any[]): void {
    console.log();
...
function cur_callproc(cur: TeradataCursor, sProcName: string, params?: any[]): void {
    console.log();
